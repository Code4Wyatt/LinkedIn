...
class ProfileJumbotron extends React.Component {
  ...
  render() {
    return (
      <>
        <UploadPic showModal={this.state.showModal} />
                ...
                <Card.Body>
                  ...
                  <div className="mutual-connections">
                    ...
                    <div className="d-flex mutual-section">
                      ...
                      ></img>
                      <a
                        className="mutual-connections-link text-muted"
                        href="#"
                      >
                        <p className="mutual">
                          <b>12 mutual connections:</b> Tobia De Angelis,
                          Stefano Casasasola and 10 others
                        </p>
                      </a>
                    </div>
                  </div>
