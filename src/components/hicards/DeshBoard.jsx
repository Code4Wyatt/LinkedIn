...
const DeshBoard = () => {
  return (
    <Container className="desh-container">
      <div className="desh-body">
        {/* <Card className="desh-body"> */}
        ...
        <div className="content background-color-none">
          <div className="desh-header-main">
            <div className="desh-header">
              <Row style={{ border: "20px", margin: "20px" }}>
                <Col>
                  <Row
                    style={{
          ...
          <div className="creator-section">
            <Row>
              <Col>
                <div className="creation-section1">
                      ...
                      <Row>
                        ...
                        <Col>
                          <div className="dashboard">
                            ...
                            <p>
                              {" "}
                              See how your salary compares to others in
                              community.
                            </p>
                          </div>
                        </Col>
