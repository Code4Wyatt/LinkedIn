  ...
  fetchProfiles = async (id) => {
    try {
        ...
        const response = await fetch(
          `https://striveschool-api.herokuapp.com/api/profile/`,  { headers: {
      ...
      <>
        <Container fluid className="sideBarCon">
          ...
          <div className="sideBarRow d-flex justify-content-center">
              <img className="jobImg w-100" src="https://static-exp1.licdn.com/scds/common/u/images/promo/ads/li_evergreen_jobs_ad_300x250_v1.jpg" alt=""/>
              </div>
          </Row>

           <Row>
          <div className="sideBarRow" style={{minHeight: 'fit'}}> 
          <p className="p-3" style={{fontWeight:'bold'}}>People also viewed</p>
          ...
          {viewedPeople.map((p)=>
                 ...
                 <Col xs={4} className="d-flex sideImgCol">
                   ...
                   <img className="img-fluid h-100 w-100" src={p.image} style={{borderRadius: '80px'}}/>
                   </div>
                 </Col>
          ...
          <Row>
          <div className="sideBarRow"> 
          <p className="p-3" style={{fontWeight:'bold'}}>People you may know</p>
          ...
          <Row>
          <div className="sideBarRow"> 
          <p className="p-3" style={{fontWeight:'bold'}}>Claudia, learn what hiring managers look for in answers to top interview questions</p>
                 ...
                 <Col xs={8} className="sideBarPeople">
                   <p> Tell me about a time you surpassed people's expectations. </p>
                 </Col>
                 </Row> 
                 <Row className="d-inline-flex p-4 m-0" style={{height: '50px'}}>
                 <Col xs={4} className="d-flex sideImgCol">
